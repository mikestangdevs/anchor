 ...
 *
 * This file is compiled to dist/mcp-server.js and invoked by `acr run-mcp`.
 * It is a separate entrypoint so the MCP server can run as a standalone process
 * without loading CLI/commander code.
 */
